...
- (void)addRecord: (NSArray*)record {
    ...
    for(uint i=0; i<record.count; i++){
        ...
        [col1.layer setBorderColor:[[UIColor blackColor] CGColor]];
        ...
        if(self->numRows == 0){
            ...
            col1.textColor = [UIColor colorWithRed:0.061 green:0.337 blue:0.173 alpha:1.000];
			col1.backgroundColor = [UIColor colorWithRed:0.615 green:0.847 blue:0.709 alpha:1.000];
        }
        else
        {
