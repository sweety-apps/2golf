...
ON_SIGNAL2( BeeUIBoard, signal )
{
	...
	if ( [signal is:BeeUIBoard.CREATE_VIEWS] )
	{
        ...
        {
            [self setTitleViewWithIcon:__IMAGE(@"titleicon") andTitleString:__TEXT(@"manage_address")];
        }
        else
        {
            [self setTitleViewWithIcon:__IMAGE(@"titleicon") andTitleString:__TEXT(@"select_address")];
        }
